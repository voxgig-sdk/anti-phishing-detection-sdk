...
raise a `AntiPhishingDetectionError` (a `StandardError` subclass), so wrap
...
```
rb/
├── AntiPhishingDetection_sdk.rb       -- Main SDK module
...
The main module (`AntiPhishingDetection_sdk`) exports the SDK class
