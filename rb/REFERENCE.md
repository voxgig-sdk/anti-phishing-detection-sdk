# AntiPhishingDetection Ruby SDK Reference

Complete API reference for the AntiPhishingDetection Ruby SDK.
...
#### `AntiPhishingDetectionSDK.test(testopts = nil, sdkopts = nil)`
...
```ruby
results, err = client.Detection.list(nil)
```
