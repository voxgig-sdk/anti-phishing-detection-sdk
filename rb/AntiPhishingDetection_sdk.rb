...
require_relative 'AntiPhishingDetection_types'
...
class AntiPhishingDetectionSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = AntiPhishingDetectionHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = AntiPhishingDetectionHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, AntiPhishingDetectionFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    AntiPhishingDetectionUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = AntiPhishingDetectionHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = AntiPhishingDetectionHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = AntiPhishingDetectionHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def op_denied(op)
    ...
    {
      "ok" => false,
      "err" => AntiPhishingDetectionError.new(
        "#{op}_allow",
  ...
  def raw_request(fetchargs = {})
    ...
    rescue AntiPhishingDetectionError => err
    ...
    if fetched.is_a?(Hash)
      status = AntiPhishingDetectionHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = AntiPhishingDetectionError.new(
        "graphql_error", "AntiPhishingDetectionSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = AntiPhishingDetectionSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
