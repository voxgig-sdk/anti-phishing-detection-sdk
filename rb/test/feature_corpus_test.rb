# AntiPhishingDetection SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # AntiPhishingDetectionSDK.new, not AntiPhishingDetectionSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    AntiPhishingDetectionSDK.new(opts)
  end
