...
#      offline in seeded test mode (AntiPhishingDetectionSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "AntiPhishingDetection_sdk.rb")
  SDK_CLASS = "AntiPhishingDetectionSDK"
  ...
  SDK_BASE = "AntiPhishingDetection_sdk"
