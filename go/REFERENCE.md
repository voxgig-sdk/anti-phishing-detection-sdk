# AntiPhishingDetection Golang SDK Reference

Complete API reference for the AntiPhishingDetection Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *AntiPhishingDetectionSDK`
...
#### `Detection(data map[string]any) AntiPhishingDetectionEntity`

Create a new `Detection` entity instance. Pass `nil` for no initial data.
...
| `indicators` | `[]any` | No | List of phishing indicators detected |
...
| `score` | `float64` | No | Confidence score of the detection (0-100) |
