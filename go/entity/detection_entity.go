...
type DetectionEntity struct {
	name    string
	client  *core.AntiPhishingDetectionSDK
...
func NewDetectionEntity(client *core.AntiPhishingDetectionSDK, entopts map[string]any) *DetectionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DetectionEntity) GetName() string { return e.name }
...
func (e *DetectionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DetectionEntity) Deleted() bool {
	return e.deleted
}


func (e *DetectionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDetectionEntity(e.client, opts)
}

func (e *DetectionEntity) Data(args ...any) any {
...
func (e *DetectionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *DetectionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DetectionEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *DetectionEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
func (e *DetectionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DetectionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DetectionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
