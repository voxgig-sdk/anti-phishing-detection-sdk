...
// instead of `sdk.NewAntiPhishingDetectionSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *AntiPhishingDetectionSDK  { return NewAntiPhishingDetectionSDK(nil) }
func Test() *AntiPhishingDetectionSDK { return TestSDK(nil, nil) }
