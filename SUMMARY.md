...
Results: Successful analysis of the URL; Successful scan operation.
...
| --- | --- | --- | --- |
| Detection | `create` | `POST /check` | Required |
| Detection | `list` | `GET /scan` | Required |

## Connect to the API

- Production server: `https://api.fishfish.gg`
...
- `anti-phishing-detection_list`: List records for an entity. Supported entities: `detection`.
- `anti-phishing-detection_load`: Load one record for an entity. No active entity supports this operation.
