...
// AntiPhishingDetection SDK ratelimit feature
...
class AntiPhishingDetectionRatelimitFeature extends AntiPhishingDetectionBaseFeature
{
    ...
    private function _acquire(AntiPhishingDetectionContext $ctx): void
    {
    ...
    private function _track(AntiPhishingDetectionContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
