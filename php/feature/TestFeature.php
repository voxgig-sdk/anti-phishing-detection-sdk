...
// AntiPhishingDetection SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class AntiPhishingDetectionTestFeature extends AntiPhishingDetectionBaseFeature
{
    ...
    public function init(AntiPhishingDetectionContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (AntiPhishingDetectionContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = AntiPhishingDetectionParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (AntiPhishingDetectionContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(AntiPhishingDetectionContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = AntiPhishingDetectionParam::call($ctx, $k);
