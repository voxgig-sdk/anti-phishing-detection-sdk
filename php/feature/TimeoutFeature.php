...
// AntiPhishingDetection SDK timeout feature
...
class AntiPhishingDetectionTimeoutFeature extends AntiPhishingDetectionBaseFeature
{
    ...
    private function _with_timeout(AntiPhishingDetectionContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(AntiPhishingDetectionContext $_ctx, float $ms): void
    {
        $client = $this->client;
