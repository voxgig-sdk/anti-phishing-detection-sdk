...
// AntiPhishingDetection SDK streaming feature
...
class AntiPhishingDetectionStreamingFeature extends AntiPhishingDetectionBaseFeature
{
    ...
    private function _iterate(AntiPhishingDetectionResult $result): \Generator
    {
    ...
    private function _streamable(AntiPhishingDetectionContext $ctx): bool
    {
