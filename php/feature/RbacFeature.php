...
// AntiPhishingDetection SDK rbac feature
...
class AntiPhishingDetectionRbacFeature extends AntiPhishingDetectionBaseFeature
{
    ...
    private function _required(AntiPhishingDetectionContext $ctx): ?string
    {
    ...
    private function _reject(AntiPhishingDetectionContext $ctx, string $required): void
    {
    ...
    private function _track(AntiPhishingDetectionContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
