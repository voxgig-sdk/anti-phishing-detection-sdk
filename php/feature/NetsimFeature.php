...
// AntiPhishingDetection SDK netsim feature
...
class AntiPhishingDetectionNetsimFeature extends AntiPhishingDetectionBaseFeature
{
    ...
    private function _simulate(AntiPhishingDetectionContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(AntiPhishingDetectionContext $ctx, array $applied): void
    {
        $client = $this->client;
