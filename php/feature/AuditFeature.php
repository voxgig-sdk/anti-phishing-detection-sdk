...
// AntiPhishingDetection SDK audit feature
...
class AntiPhishingDetectionAuditFeature extends AntiPhishingDetectionBaseFeature
{
    ...
    private function _emit(AntiPhishingDetectionContext $ctx, string $outcome): void
    {
