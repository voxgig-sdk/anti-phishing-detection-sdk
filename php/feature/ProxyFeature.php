...
// AntiPhishingDetection SDK proxy feature
...
class AntiPhishingDetectionProxyFeature extends AntiPhishingDetectionBaseFeature
{
    ...
    public function init(AntiPhishingDetectionContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (AntiPhishingDetectionContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
