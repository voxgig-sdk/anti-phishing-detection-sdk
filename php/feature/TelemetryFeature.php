...
// AntiPhishingDetection SDK telemetry feature
...
class AntiPhishingDetectionTelemetryFeature extends AntiPhishingDetectionBaseFeature
{
    ...
    private function _close(AntiPhishingDetectionContext $ctx, bool $ok): void
    {
