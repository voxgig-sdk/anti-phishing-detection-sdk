...
class DetectionDirectTest extends TestCase
{
    public function test_direct_list_detection(): void
    {
        $setup = detection_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-detection", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
