...
class DetectionEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $base = AntiPhishingDetectionSDK::test($seed, null);
        $seen = iterator_to_array($base->Detection(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->Detection(null)->stream("list", null, null) as $item) {
