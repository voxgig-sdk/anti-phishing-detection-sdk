...
// AntiPhishingDetection SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (AntiPhishingDetectionSDK::test)
...
{
    private const SDK_CLASS = 'AntiPhishingDetectionSDK';
    ...
    private const SDK_BASE = 'antiphishingdetection_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../antiphishingdetection_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
