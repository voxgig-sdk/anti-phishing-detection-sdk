...
// AntiPhishingDetection SDK pipeline test
//
...
{
    private static function utility(): AntiPhishingDetectionUtility
    {
        return new AntiPhishingDetectionUtility();
    }
    ...
    private static function ctx(array $over = []): AntiPhishingDetectionContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new AntiPhishingDetectionContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new AntiPhishingDetectionOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof AntiPhishingDetectionError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new AntiPhishingDetectionOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = AntiPhishingDetectionMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new AntiPhishingDetectionOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = AntiPhishingDetectionMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new AntiPhishingDetectionOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = AntiPhishingDetectionMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new AntiPhishingDetectionSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = AntiPhishingDetectionMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new AntiPhishingDetectionResponse([]),
            'result' => new AntiPhishingDetectionResult([]),
        ]);
        [, $err] = AntiPhishingDetectionMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new AntiPhishingDetectionSpec([]),
            'response' => null,
            'result' => new AntiPhishingDetectionResult([]),
        ]);
        [, $err] = AntiPhishingDetectionMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new AntiPhishingDetectionSpec(['step' => 's']),
            'response' => new AntiPhishingDetectionResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new AntiPhishingDetectionResult([]),
        ]);
        [, $err] = AntiPhishingDetectionMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new AntiPhishingDetectionSpec(['step' => 's']),
            'response' => new AntiPhishingDetectionResponse(self::resp(200, ['v' => 1])),
            'result' => new AntiPhishingDetectionResult([]),
        ]);
        [, $err] = AntiPhishingDetectionMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new AntiPhishingDetectionSpec(['step' => 's']),
            'response' => new AntiPhishingDetectionResponse(self::resp(200, ['v' => 2])),
            'result' => new AntiPhishingDetectionResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        AntiPhishingDetectionMakeResponse::call($ctx);
    ...
    {
        $preset = new AntiPhishingDetectionResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new AntiPhishingDetectionSpec([]),
            'response' => new AntiPhishingDetectionResponse([]),
            'result' => new AntiPhishingDetectionResult([]),
        ...
        [$got, $err] = AntiPhishingDetectionMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new AntiPhishingDetectionResult([])]);
        [, $err] = AntiPhishingDetectionMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new AntiPhishingDetectionSpec([]), 'result' => null]);
        [, $err] = AntiPhishingDetectionMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new AntiPhishingDetectionSpec(['step' => 's']),
            'result' => new AntiPhishingDetectionResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new AntiPhishingDetectionOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = AntiPhishingDetectionMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new AntiPhishingDetectionSpec(['step' => 's']),
            'result' => new AntiPhishingDetectionResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new AntiPhishingDetectionOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = AntiPhishingDetectionMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new AntiPhishingDetectionResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new AntiPhishingDetectionSpec([]),
            'result' => new AntiPhishingDetectionResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = AntiPhishingDetectionMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = AntiPhishingDetectionMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new AntiPhishingDetectionError('boom', 'boom');
        $utility->fetcher = function (AntiPhishingDetectionContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new AntiPhishingDetectionSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = AntiPhishingDetectionMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (AntiPhishingDetectionContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = AntiPhishingDetectionMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(AntiPhishingDetectionResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        AntiPhishingDetectionMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (AntiPhishingDetectionContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new AntiPhishingDetectionSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = AntiPhishingDetectionMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new AntiPhishingDetectionResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new AntiPhishingDetectionSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = AntiPhishingDetectionMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = AntiPhishingDetectionMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = AntiPhishingDetectionMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new AntiPhishingDetectionResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, AntiPhishingDetectionDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new AntiPhishingDetectionResult(['ok' => false])]);
        $this->expectException(AntiPhishingDetectionError::class);
        AntiPhishingDetectionDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new AntiPhishingDetectionResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', AntiPhishingDetectionMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        AntiPhishingDetectionMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new AntiPhishingDetectionBaseFeature();
        $b = new AntiPhishingDetectionBaseFeature();
        AntiPhishingDetectionFeatureAdd::call($ctx, $a);
        AntiPhishingDetectionFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): AntiPhishingDetectionBaseFeature
    {
        $f = new AntiPhishingDetectionBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        AntiPhishingDetectionFeatureAdd::call($ctx, self::named_feature('a'));
        AntiPhishingDetectionFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        AntiPhishingDetectionFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        AntiPhishingDetectionFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        AntiPhishingDetectionFeatureAdd::call($ctx, $replace);
        ...
        AntiPhishingDetectionFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): AntiPhishingDetectionContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new AntiPhishingDetectionSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = AntiPhishingDetectionPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        AntiPhishingDetectionPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new AntiPhishingDetectionResponse(['headers' => null]),
            'result' => new AntiPhishingDetectionResult([]),
        ]);
        AntiPhishingDetectionResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        AntiPhishingDetectionResultBody::call($ctx);
