...
// AntiPhishingDetection SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class AntiPhishingDetectionMakeRequest
{
    public static function call(AntiPhishingDetectionContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new AntiPhishingDetectionResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new AntiPhishingDetectionResponse($fetched);
        } else {
