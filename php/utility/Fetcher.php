...
// AntiPhishingDetection SDK utility: fetcher

class AntiPhishingDetectionFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; AntiPhishingDetectionSDK/1.0)';
    ...
    public static function call(AntiPhishingDetectionContext $ctx, string $fullurl, array $fetchdef): array
    {
