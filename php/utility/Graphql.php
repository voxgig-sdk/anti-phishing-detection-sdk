...
// AntiPhishingDetection SDK utility: graphql
//
...
class AntiPhishingDetectionGraphql
{
    ...
    // equivalent.
    public static function body(AntiPhishingDetectionContext $ctx): mixed
    {
    ...
    public static function errors(AntiPhishingDetectionContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
