...
class AntiPhishingDetectionSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = AntiPhishingDetectionHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = AntiPhishingDetectionHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!AntiPhishingDetectionFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, AntiPhishingDetectionFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return AntiPhishingDetectionUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = AntiPhishingDetectionHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = AntiPhishingDetectionHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = AntiPhishingDetectionHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new AntiPhishingDetectionError($op . "_allow",
                "AntiPhishingDetectionSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = AntiPhishingDetectionHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new AntiPhishingDetectionError("graphql_error",
                "AntiPhishingDetectionSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Detection($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_detection === null) {
                $this->_detection = new DetectionEntity($this, null);
            }
            return $this->_detection;
        }
        return new DetectionEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new AntiPhishingDetectionSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
