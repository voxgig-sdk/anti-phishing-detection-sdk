...
type Args struct {
	Entity string         `json:"entity" jsonschema:"detection"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.AntiPhishingDetectionSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "anti-phishing-detection_list",
		Description: "List records from AntiPhishingDetection. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "anti-phishing-detection_load",
		Description: "Load a single record from AntiPhishingDetection. " +
...
func runOp(client *sdk.AntiPhishingDetectionSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.AntiPhishingDetectionSDK, name string) (sdk.AntiPhishingDetectionEntity, error) {
	switch strings.ToLower(name) {
	case "detection":
		return client.Detection(nil), nil
