// Command AntiPhishingDetection-mcp is an MCP server exposing the AntiPhishingDetection
// SDK as MCP tools.
//
// Two tools are registered:
//
//	AntiPhishingDetection_list  — list records of an entity
//	AntiPhishingDetection_load  — load a single record of an entity
//
