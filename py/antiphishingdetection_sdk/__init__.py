...
from antiphishingdetection_sdk.utility import register

# Load features
from antiphishingdetection_sdk.feature.base_feature import AntiPhishingDetectionBaseFeature
from antiphishingdetection_sdk.features import _has_feature, _make_feature
...
class AntiPhishingDetectionSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = AntiPhishingDetectionUtility()
    ...
    def get_utility(self):
        return AntiPhishingDetectionUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("AntiPhishingDetectionSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Detection(self, data=None) -> "DetectionEntity":
        ...
        from antiphishingdetection_sdk.entity.detection_entity import DetectionEntity
