# AntiPhishingDetection SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions AntiPhishingDetectionSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both AntiPhishingDetectionSDK(...) and AntiPhishingDetectionSDK.test(...) become
#      AntiPhishingDetectionSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "antiphishingdetection_sdk"
_SDK_CLASS = "AntiPhishingDetectionSDK"
