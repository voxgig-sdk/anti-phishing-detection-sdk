# AntiPhishingDetection SDK — root README python-examples test.
#
...
def test_readme_python_blocks_typecheck():
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        # Resolve "from antiphishingdetection_sdk import AntiPhishingDetectionSDK" against the package root.
...
def test_readme_testmode_snippets_run():
    ...
    for i, block in enumerate(blocks):
        ...
        namespace = {"AntiPhishingDetectionSDK": AntiPhishingDetectionSDK, "os": os}
        try:
