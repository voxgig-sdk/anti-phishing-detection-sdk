...
The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Detection()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/anti-phishing-detection-sdk/releases)) or
...
```
py/
├── antiphishingdetection_sdk.py         -- Main SDK module
