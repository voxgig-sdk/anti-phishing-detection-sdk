...
|---|---|---|
| `ts/` | @voxgig-sdk/anti-phishing-detection-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/anti-phishing-detection-sdk \
      --repository voxgig-sdk/anti-phishing-detection-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/anti-phishing-detection-sdk` shows it, and
`npm trust revoke @voxgig-sdk/anti-phishing-detection-sdk --id=<id>` removes it.
