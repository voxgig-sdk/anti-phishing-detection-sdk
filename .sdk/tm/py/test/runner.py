...
class AntiPhishingDetectionTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = AntiPhishingDetectionTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = AntiPhishingDetectionTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = AntiPhishingDetectionTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
