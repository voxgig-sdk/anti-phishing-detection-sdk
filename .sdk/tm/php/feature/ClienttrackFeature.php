...
// AntiPhishingDetection SDK clienttrack feature
...
class AntiPhishingDetectionClienttrackFeature extends AntiPhishingDetectionBaseFeature
{
    ...
    public function PostConstruct(AntiPhishingDetectionContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'AntiPhishingDetection-SDK';
