...
// AntiPhishingDetection SDK cache feature
...
class AntiPhishingDetectionCacheFeature extends AntiPhishingDetectionBaseFeature
{
    ...
    private function _through(AntiPhishingDetectionContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
