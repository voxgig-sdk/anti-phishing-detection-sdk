...
// AntiPhishingDetection SDK utility: result_basic

class AntiPhishingDetectionResultBasic
{
    public static function call(AntiPhishingDetectionContext $ctx): ?AntiPhishingDetectionResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof AntiPhishingDetectionError) ? $result->err->msg : (string)$result->err;
