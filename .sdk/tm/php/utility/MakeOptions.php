...
// AntiPhishingDetection SDK utility: make_options

class AntiPhishingDetectionMakeOptions
{
    ...
    public static function call(AntiPhishingDetectionContext $ctx): array
    {
        ...
        //
        // `AntiPhishingDetectionSchema::optspec()` is built from the model:
        ...
        $optspec = AntiPhishingDetectionSchema::optspec();
