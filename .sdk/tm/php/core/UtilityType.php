...
// AntiPhishingDetection SDK utility type

class AntiPhishingDetectionUtility
{
    ...
    public static function copy(AntiPhishingDetectionUtility $src): AntiPhishingDetectionUtility
    {
        $u = new AntiPhishingDetectionUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
