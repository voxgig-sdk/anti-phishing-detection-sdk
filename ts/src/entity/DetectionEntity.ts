...
class DetectionEntity extends AntiPhishingDetectionEntityBase<Detection> {
  ...
  async list(this: any, reqmatch?: DetectionListMatch, ctrl?: Control): Promise<DetectionEntity[]> {
  ...
  async create(this: any, reqdata?: DetectionCreateData, ctrl?: Control): Promise<DetectionEntity> {
