...
(0, node_test_1.describe)('DetectionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.AntiPhishingDetectionSDK({
    ...
    (0, node_test_1.test)('direct-list-detection', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-detection', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.ANTI_PHISHING_DETECTION_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.AntiPhishingDetectionSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.ANTI_PHISHING_DETECTION_APIKEY,
        }));
        let idmap = env['ANTI_PHISHING_DETECTION_TEST_DETECTION_ENTID'];
    ...
    const client = new __1.AntiPhishingDetectionSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=DetectionDirect.test.js.map