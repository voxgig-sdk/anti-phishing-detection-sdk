...
func registerSDKWords(r *eng.Registry, client *sdk.AntiPhishingDetectionSDK) {
...
func runOp(client *sdk.AntiPhishingDetectionSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
