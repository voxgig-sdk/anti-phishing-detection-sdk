...
describe("DetectionDirect", function()
  it("should direct-list-detection", function()
    local setup = detection_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-detection", setup.live and "live" or "unit")
...
function detection_direct_setup(mockres)
